import { Box, Heading, Image ,Container,Text,Stack, transform} from '@chakra-ui/react'
...
const Home = () => {
  return (
    ...
    const MyCarousel = () => (
      ...
      >
        <Box w="full">
          <Image src={img1}  w={'full'} objectFit={'cover'} />
        ...
        <Box w="full" >
          ...
          <Heading alignSelf={'center'} bgColor={'whiteAlpha.600'} color={'black'} {...headingOptions}>
            Gaming on Console
          </Heading>
        </Box>
